...
func ToUserResponseDTO(entity entity.User) UserResponseDTO {
...
func ToUserRoleDTO(role entity.UserRole) UserRoleDTO {
	return UserRoleDTO{
...
func ToUserStatusDTO(role entity.UserStatus) UserStatusDTO {
