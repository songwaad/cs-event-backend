...
func NewHttpBudgetHandler(budgetUseCase usecase.BudgetUseCase) *HttpBudgetHandler {
	return &HttpBudgetHandler{budgetUseCase: budgetUseCase}
}
...
// @Failure 500 {object} map[string]interface{}
// @Router /budgets [get]
func (h *HttpBudgetHandler) GetAllBudgets(c *fiber.Ctx) error {
