...
import (
	...
	"github.com/songwaad/cs-event-backend/internal/dto"
...
type HttpEventHandler struct {
	...
	notifyUseCase usecase.NotificationUsecase
}

func NewHttpEventHandler(eventUseCase usecase.EventUseCase, userUseCase usecase.UserUseCase, notifyUseCase usecase.NotificationUsecase) *HttpEventHandler {
...
// @Produce  json
// @Security ApiKeyAuth
// @Success 200 {array} entity.EventTypeStatus "Successfully retrieved all event type status"
...
// @Produce  json
// @Security ApiKeyAuth
// @Success 200 {array} entity.EventType "Successfully retrieved all event types"
// @Failure 500 {object} map[string]interface{} "Internal server error"
...
// @Produce  json
// @Security ApiKeyAuth
// @Success 200 {array} entity.EventStatus "Successfully retrieved all event status"
// @Failure 500 {object} map[string]interface{} "Internal server error"
...
// @Produce  json
// @Security ApiKeyAuth
// @Success 200 {array} entity.EventPlan "Successfully retrieved all event plans"
// @Failure 500 {object} map[string]interface{} "Internal server error"
...
// @Success 201 {object} map[string]interface{} "Successfully created event"
