...
type HttpSpeakerHandler struct {
	speakerUseCase usecase.SpeakerUseCase
}

func NewHttpSpeakerHandler(speakerUseCase usecase.SpeakerUseCase) *HttpSpeakerHandler {
