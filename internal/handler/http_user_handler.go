...
import (
	...
	appJwt "github.com/songwaad/cs-event-backend/pkg/jwt"
)
...
func (h *UserHandler) Login(c *fiber.Ctx, jwtSecretKey string) error {
	...
	t, err := appJwt.GenerateToken(user.UserID, user.UserRole.Role, jwtSecretKey)
	if err != nil {
...
// @Produce json
// @Security ApiKeyAuth
// @Success 200 {object} dto.UserResponseDTO "Current user details"
...
func (h *UserHandler) GetMe(c *fiber.Ctx) error {
	...
	return c.Status(fiber.StatusOK).JSON(dto.ToUserResponseDTO(*user))
}
